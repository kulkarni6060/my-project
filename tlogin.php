...
if(isset($_POST['submit'])){
	...
	$email_search = " select * from registrationtwo where email='$email' ";
...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <p class="text-center">Not Have an account? <a href="tregis.php">SignUp Here</a> </p>                                                                 
</form>
</article>
</div> <!-- card.// -->
